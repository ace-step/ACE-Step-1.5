(function () {
  ...
  const I18N = {
    en: {
      ...
      'label.repainting_start': 'Source start (Remix)',
      'label.repainting_end': 'Source end (Remix)',
      'opt.use_adg': 'Use ADG',
      ...
      'help.repainting_start': 'Optional start time in seconds for the source-audio window used by Remix.',
      'help.repainting_end': 'Optional end time in seconds for the Remix source window. Use -1 to continue until the end of the file.',
    ...
    it: {
      ...
      'label.repainting_start': 'Inizio sorgente (Remix)',
      'label.repainting_end': 'Fine sorgente (Remix)',
      'opt.use_adg': 'Usa ADG',
      ...
      'help.repainting_start': 'Tempo di inizio opzionale, in secondi, della finestra di audio sorgente usata da Remix.',
      'help.repainting_end': 'Tempo di fine opzionale, in secondi, della finestra sorgente di Remix. Usa -1 per arrivare fino alla fine del file.',
      'ph.timesteps': '0.97,0.76,0.615,0.5,0.395,0.28,0.18,0.085,0',
