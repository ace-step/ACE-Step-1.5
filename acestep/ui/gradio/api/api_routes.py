    ...
    try:
        ...
        for audio in result.audios:
            ...
            item = {
                ...
                "bpm": audio_params.get("cot_bpm") or (audio_params.get("bpm") if audio_params.get("bpm") and audio_params.get("bpm") > 0 else None),
                "duration": audio_params.get("cot_duration") or (audio_params.get("duration") if audio_params.get("duration") and audio_params.get("duration") > 0 else None),
