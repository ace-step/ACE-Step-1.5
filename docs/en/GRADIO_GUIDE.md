...
| **Audio Duration** | Auto/-1 | Target length in seconds (10-600). -1 or unset defaults to **120 seconds** (deterministic, not random). Set explicitly for a different length. |
